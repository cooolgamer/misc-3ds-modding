...
## How 2 install
Just download the zip from this folder, and extract the luma folder on the root of your sd card, **you must use the Japanese 3DS Camera from the 1.0 firmware**.
